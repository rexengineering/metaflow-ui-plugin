...
import PostTaskModal from "../../components/PostTaskModal/PostTaskModal.container";
...
function App({deployments, activeWorkflows, talkTracks, dispatch, children}) {
        ...
        <div className={classes.app}>
            ...
            <Pane>
                ...
                <Tray className={classes.tray3}>
                    <PostTaskModal workflowID="SDFGDFG" />
                    <Notes />
